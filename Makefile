...
marc_grep_tokenizer_test: marc_grep_tokenizer_test.o MarcGrepTokenizer.o libmarc.a
	$(CCC) -o $@ $< MarcGrepTokenizer.o -L. -lmarc -lpcre -lcrypto
...
BibleReferenceParser.o: BibleReferenceParser.cc BibleReferenceParser.h StringUtil.h Locale.h
	$(CCC) $(CCOPTS) $<
...
db_lookup: db_lookup.o libmarc.a
	$(CCC) -o $@ $^ -L. -lmarc -lpcre -lcrypto -ltokyocabinet

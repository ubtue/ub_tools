...
marc_grep2: marc_grep2.o lib/libmarc.a
	$(CCC) $(LDFLAGS) -o $@ $< -L. -Llib -lmarc -lpcre -lcrypto
...
augment_bible_references: augment_bible_references.o  lib/libmarc.a
	$(CCC) $(LDFLAGS) -o $@ augment_bible_references.o -L. -Llib -lmarc -lpcre -lcrypto
...
bib_ref_parser_test: bib_ref_parser_test.o
	$(CCC) $(LDFLAGS) -o $@ $^ -L. -Llib -lmarc -lpcre -lcrypto -lmagic
...
download_test: download_test.o lib/libmarc.a
	$(CCC) $(LDFLAGS) -o $@ $^ -L. -Llib -lmarc -lpcre -lcrypto -lkyotocabinet -lmagic
...
db_lookup: db_lookup.o lib/libmarc.a
	$(CCC) $(LDFLAGS) -o $@ $^ -L. -Llib -lmarc -lpcre -lcrypto -lkyotocabinet

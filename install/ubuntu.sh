...
apt -y install clang golang wget curl git apache2 libapache2-mod-gnutls mysql-server php7.0 php7.0-dev \
    php-pear php7.0-json php7.0-ldap php7.0-mcrypt php7.0-mysql php7.0-xsl php7.0-intl php7.0-gd jq \
    ...
    libboost-all-dev clang-3.8 clang++-3.8 clang golang cifs-utils
a2enmod rewrite
phpenmod mcrypt

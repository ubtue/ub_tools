#!/usr/bin/python3
# Original file from https://github.com/sskorol/ner-spacy-doccano
# coding: utf8
import json
import plac
import random
...
LABELS = ["bib_info", "further_literature", "further_publication"]
TRAINING_DATA = []
VERIFICATION_DATA = []
...
def main(model='en_core_web_lg', new_model_name='ner', output_dir='./model', n_iter=30):

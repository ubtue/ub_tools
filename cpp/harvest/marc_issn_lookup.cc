...
[[noreturn]] void Usage() {
    ::Usage(
        "marc_inputitlearticles marc_inputitlejournals marc_outputitlearticles [--verbose]"
        "\n"
        "- marc_inputitlearticles is a file containing all article information taken from CORE.\n"
        "- marc_inputitlejournals is a file containing journal information. Please use issn_lookup.py to generate this file.\n"
        "- marc_outputitlearticles is an output file generated by this tool.\n"

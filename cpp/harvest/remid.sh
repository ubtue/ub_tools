...
marc_augmentor $FILE_TEMP_CLEAN $FILE_TEMP  --insert-field '852:  \x1FaDE-Tue135' \
    ...
    --insert-field '866:  \x1FaSPQUE#Universitätsbibliothek Marburg#SPSAM#Archiv des Religionswissenschaftlichen Medien- und Informationsdienstes e. V. (REMID)\x1F2LOK' \

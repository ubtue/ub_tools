...
CREATE TABLE miscellaneous_translations (
  token VARCHAR(255) NOT NULL,
  language_code CHAR(4) NOT NULL,
  translation VARCHAR(1024) NOT NULL,
  translator VARCHAR(50),
  UNIQUE KEY token_language_code (token,language_code),
  KEY miscellaneous_translations_idx_token (token),
  KEY miscellaneous_translations_idx_language_code (language_code)
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE keyword_translations (
  ...
  translator VARCHAR(50),
  german_updated TINYINT(1) DEFAULT FALSE,

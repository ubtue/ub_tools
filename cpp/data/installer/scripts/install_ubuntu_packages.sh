...
apt-get --quiet --yes --allow-unauthenticated install \
        ant apache2 ca-certificates cifs-utils clang cron curl fetchmail gcc git imagemagick incron jq libarchive-dev \
        ...
        tesseract-ocr-spa tesseract-ocr-swe tidy unzip uuid-dev wget xsltproc

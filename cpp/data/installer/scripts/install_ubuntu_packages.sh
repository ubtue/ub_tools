...
apt-get --quiet --yes --allow-unauthenticated install \
    ...
    ca-certificates libarchive-dev libboost-all-dev libcurl4-gnutls-dev libkyotocabinet-dev liblept5 libleptonica-dev liblz4-tool libmagic-dev libmysqlclient-dev libopenjpeg5 libpcre3-dev libpoppler58 libssl-dev libtesseract-dev libtokyocabinet-dev libwebp5 libxml2-dev libxml2-utils mawk poppler-utils uuid-dev \

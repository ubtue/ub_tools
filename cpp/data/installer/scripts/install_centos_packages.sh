...
dnf --assumeyes install \
    ...
    gawk ImageMagick incron jq libcurl-devel libdb-devel libsq3-devel libuuid-devel libwebp libxml2-devel libxml2 \
    lsof lz4 mariadb mariadb-devel mariadb-server mariadb-server-utils mod_ssl openssl-devel pcre-devel \
    policycoreutils-python-utils poppler poppler-utils rpmdevtools sqlite3 tidy unzip xerces-c-devel

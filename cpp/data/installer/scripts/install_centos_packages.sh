...
dnf --assumeyes install \
    ...
    mariadb-devel mariadb-server mariadb-server-utils mod_ssl mutt openssl-devel pcre-devel python3-pexpect policycoreutils-python-utils \
    poppler poppler-utils python3 python3-pyflakes rpmdevtools sqlite sudo tidy unzip xerces-c-devel yaz

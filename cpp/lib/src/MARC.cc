...
static std::unordered_map<Tag, bool> tag_to_repeatable_map{
    ...
    { Tag("020"), true },  { Tag("022"), true },  { Tag("023"), true },  { Tag("024"), true },
    { Tag("025"), true },  { Tag("026"), true },  { Tag("027"), true },  { Tag("028"), true },
    { Tag("030"), true },  { Tag("031"), true },  { Tag("032"), true },  { Tag("033"), true },
    { Tag("034"), true },  { Tag("035"), true },  { Tag("036"), false }, { Tag("037"), true },
    { Tag("038"), false }, { Tag("040"), false }, { Tag("041"), true },  { Tag("042"), false },
    { Tag("043"), false }, { Tag("044"), false }, { Tag("045"), false }, { Tag("046"), true },
    { Tag("047"), true },  { Tag("048"), true },  { Tag("050"), true },  { Tag("051"), true },
    { Tag("052"), true },  { Tag("055"), true },  { Tag("060"), true },  { Tag("061"), true },
    { Tag("065"), true },  { Tag("066"), false }, { Tag("070"), true },  { Tag("071"), true },
    { Tag("072"), true },  { Tag("074"), true },  { Tag("080"), true },  { Tag("082"), true },
    { Tag("083"), true },  { Tag("084"), true },  { Tag("085"), true },  { Tag("086"), true },
    { Tag("088"), true },  { Tag("100"), false }, { Tag("110"), false }, { Tag("111"), false },
    { Tag("130"), false }, { Tag("150"), false }, { Tag("151"), false }, { Tag("186"), true }, // non-standard field only used locally
    ...
    { Tag("375"), true },  { Tag("377"), true },  { Tag("380"), true },  { Tag("381"), true },
    { Tag("382"), true },  { Tag("383"), true },  { Tag("384"), false }, { Tag("385"), true },
    { Tag("386"), true },  { Tag("388"), true },  { Tag("400"), true },  { Tag("410"), true },
    { Tag("411"), true },  { Tag("430"), true },  { Tag("450"), true },  { Tag("451"), true },
    ...
    { Tag("525"), true },  { Tag("526"), true },  { Tag("530"), true },  { Tag("532"), true },
    { Tag("533"), true },  { Tag("534"), true },  { Tag("535"), true },  { Tag("536"), true },
    { Tag("538"), true },  { Tag("540"), true },  { Tag("541"), true },  { Tag("542"), true },
    { Tag("545"), true },  { Tag("546"), true },  { Tag("547"), true },  { Tag("548"), true },
    { Tag("550"), true },  { Tag("551"), true },  { Tag("552"), true },  { Tag("555"), true },
    { Tag("556"), true },  { Tag("561"), true },  { Tag("562"), true },  { Tag("563"), true },
    { Tag("565"), true },  { Tag("567"), true },  { Tag("580"), true },  { Tag("581"), true },
    { Tag("583"), true },  { Tag("584"), true },  { Tag("585"), true },  { Tag("586"), true },
    { Tag("588"), true },  { Tag("600"), true },  { Tag("601"), true }, // non-standard field only used locally
    ...
    { Tag("658"), true },  { Tag("662"), true },  { Tag("667"), true },  { Tag("670"), true },
    { Tag("675"), false }, { Tag("677"), true },  { Tag("678"), true },  { Tag("680"), true },
    { Tag("682"), false }, { Tag("700"), true },  { Tag("710"), true },  { Tag("711"), true },
    { Tag("720"), true },  { Tag("730"), true },  { Tag("740"), true },  { Tag("750"), true },
    { Tag("751"), true },  { Tag("752"), true },  { Tag("752"), true },  { Tag("754"), true },
    { Tag("758"), true },  { Tag("760"), true },  { Tag("762"), true },  { Tag("765"), true },
    { Tag("767"), true },  { Tag("770"), true },  { Tag("772"), true },  { Tag("773"), true },
    { Tag("774"), true },  { Tag("775"), true },  { Tag("776"), true },  { Tag("777"), true },
    { Tag("780"), true },  { Tag("785"), true },  { Tag("786"), true },  { Tag("787"), true },
    { Tag("800"), true },  { Tag("810"), true },  { Tag("811"), true },  { Tag("830"), true },
    { Tag("841"), false }, { Tag("842"), false }, { Tag("843"), true },  { Tag("844"), true },
    { Tag("845"), true },  { Tag("850"), true },  { Tag("852"), true },  { Tag("853"), true },
    { Tag("854"), true },  { Tag("855"), true },  { Tag("856"), true },  { Tag("863"), true },
    { Tag("864"), true },  { Tag("865"), true },  { Tag("866"), true },  { Tag("867"), true },
    { Tag("868"), true },  { Tag("876"), true },  { Tag("877"), true },  { Tag("878"), true },
    { Tag("880"), true },  { Tag("882"), true },  { Tag("883"), true },  { Tag("884"), true },
    { Tag("885"), true },  { Tag("886"), true },  { Tag("887"), true },
};

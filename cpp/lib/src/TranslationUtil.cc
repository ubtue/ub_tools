...
const std::map<std::string, std::string> international_2letter_code_to_german_3or4letter_code{
    { "af", "afr" }, { "ar", "ara" }, { "da", "dan" }, { "de", "deu" }, { "el", "gre" }, { "en", "eng" },
    { "es", "spa" }, { "fr", "fra" }, { "it", "ita" }, { "ms", "msa" }, { "nl", "nld" }, { "oc", "oci" },
    { "pt", "por" }, { "ro", "rum" }, { "ru", "rus" }, { "sr", "srp" }, { "tr", "tur" },
};
...
static std::map<std::string, std::string> german_to_3or4letter_english_codes{
    { "afr", "afr" }, { "ara", "ara" }, { "dan", "dan" }, { "deu", "ger" },   { "eng", "eng" },  { "fra", "fre" }, { "gre", "gre" },
    { "ita", "ita" }, { "msa", "may" }, { "nld", "dut" }, { "oci", "oci" },   { "por", "por" },  { "rum", "ron" }, { "rus", "rus" },
    { "spa", "spa" }, { "srp", "srp" }, { "tur", "tur" }, { "hans", "hans" }, { "hant", "hant" }
};

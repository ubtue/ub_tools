...
const std::map<std::string, std::string> international_2letter_code_to_german_3or4letter_code{
    { "af", "afr" }, { "an", "arg" }, { "ar", "ara" }, { "br", "bre" }, { "ca", "cat" }, { "cs", "cze" }, { "cy", "cym" }, { "da", "dan" },
    { "de", "deu" }, { "el", "gre" }, { "en", "eng" }, { "es", "spa" }, { "et", "est" }, { "eu", "eus" }, { "fi", "fin" }, { "fr", "fra" },
    { "ga", "gaa" }, { "gl", "glg" }, { "he", "heb" }, { "ht", "hat" }, { "hr", "hrv" }, { "hu", "hun" }, { "id", "ind" }, { "is", "ice" },
    { "it", "ita" }, { "la", "lat" }, { "lv", "lav" }, { "lt", "lit" }, { "ms", "msa" }, { "mt", "mlt" }, { "nl", "nld" }, { "no", "nor" },
    { "oc", "oci" }, { "pl", "pol" }, { "pt", "por" }, { "ro", "rum" }, { "ru", "rus" }, { "sk", "slo" }, { "sl", "slv" }, { "so", "som" },
    { "sq", "sqi" }, { "sr", "srp" }, { "sv", "swe" }, { "sw", "swa" }, { "tl", "tgl" }, { "tr", "tur" }, { "uk", "ukr" }, { "vi", "vie" },
};
...
static std::map<std::string, std::string> german_to_3or4letter_english_codes{
    { "afr", "afr" },   { "ara", "ara" },  { "arg", "arg" }, { "ast", "ast" }, { "bre", "bre" }, { "cat", "cat" }, { "cym", "wel" },
    { "cze", "ces" },   { "dan", "dan" },  { "deu", "ger" }, { "eng", "eng" }, { "est", "est" }, { "eus", "baq" }, { "fin", "fin" },
    { "fra", "fre" },   { "gaa", "gaa" },  { "glg", "glg" }, { "gre", "gre" }, { "hat", "hat" }, { "heb", "heb" }, { "hrv", "hrv" },
    { "hun", "hun" },   { "ice", "isl" },  { "ind", "ind" }, { "ita", "ita" }, { "lat", "lat" }, { "lav", "lav" }, { "lit", "lit" },
    { "mlt", "mlt" },   { "msa", "may" },  { "nld", "dut" }, { "nor", "nor" }, { "oci", "oci" }, { "pol", "pol" }, { "por", "por" },
    { "rum", "ron" },   { "rus", "rus" },  { "slo", "slk" }, { "slv", "slv" }, { "som", "som" }, { "spa", "spa" }, { "sqi", "alb" },
    { "srp", "srp" },   { "swa", "swa" },  { "swe", "swe" }, { "tgl", "tgl" }, { "tur", "tur" }, { "ukr", "ukr" }, { "vie", "vie" },
    { "hans", "hans" }, { "hant", "hant" }
};

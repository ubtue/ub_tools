...
void CollectGeneralStats(const std::string &system_type, File * const output) {
    ...
    IssueQueryAndWriteOutput("*.*" + EXTRA, "Gesamt", "Gesamttreffer", system_type, output);
    IssueQueryAndWriteOutput("format:Book" + EXTRA, "Format", "Buch", system_type, output);
    IssueQueryAndWriteOutput("format:Article" + EXTRA, "Format", "Artikel", system_type, output);
    IssueQueryAndWriteOutput("mediatype:Electronic" + EXTRA, "Medientyp", "elektronisch", system_type, output);
    IssueQueryAndWriteOutput("mediatype:Non-Electronic" + EXTRA, "Medientyp", "non-elektronisch", system_type, output);
}

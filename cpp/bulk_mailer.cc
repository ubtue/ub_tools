...
[[noreturn]] void Usage() {
    ::Usage(
        "mail_contents sql_statement auxillary_email_address_list sender_and_reply_to_email_address\n"
...
void SendAllEmails(const std::string &message_file, const std::string &sender_and_reply_to_address,

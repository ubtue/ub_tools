...
readonly FIELDS_TO_UPDATE=NAME,ONLINE_PPN,ONLINE_ISSN,PRINT_PPN,PRINT_ISSN,UPLOAD_OPERATION,LICENSE,PERSONALIZED_AUTHORS,EXPECTED_LANGUAGES,ENTRY_POINT_URL,UPDATE_WINDOW,SELECTIVE_EVALUATION,SSGN

...
(marc_filter \
    ...
    --replace 600a:610a:630a:648a:650a:650x:651a:655a /usr/local/var/lib/tuelib/keyword_normalisation.map \
    --replace-strings 100a:700a /usr/local/var/lib/tuelib/author_normalisation.map \

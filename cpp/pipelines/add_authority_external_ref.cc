 ...
 * The input_txt_file is the file generated by this command:
 ...
 *
 * The output_csv_file is in new format, it uses csv format with structure:
 *      GND-ID;Wikidata-Entity-Id;Wikipedia-Address
 * The example lines of output_csv_file:

...
[[noreturn]] void Usage() {
    ::Usage("[--message-prefix=prefix [--also-log-to-stderr] log_level log_message\n"
            "where \"log_level\" must be be one of EMERG, ALERT, CRIT, ERR, WARNING, NOTICE, INFO or DEBUG.\n");
}

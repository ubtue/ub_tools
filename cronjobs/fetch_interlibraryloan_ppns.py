...
GVI_URL          = r"http://gvi.bsz-bw.de/solr/GVI/select?rows=50000&wt=json&indent=true&fl=id&q=material_media_type:Book+AND+(ill_flag:Loan+OR+ill_flag:Copy+OR+ill_flag:Ecopy)+AND+publish_date:[2000+TO+*]&sort=id+asc&fq=id:(DE-627)*"
DROP_SIGIL_REGEX = r"[(][A-Z]{2}-\d\d\d[)]"
